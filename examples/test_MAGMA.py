...
def main():
    ...
    points = [(40000, 7000), (0, 7000), (0, 0), (40000, 0)]
    ...
    def needs_refinement(vertices, area):
        ...
        max_area = 50000.# + (la.norm(bary, np.inf) - 1) * 0.01
    ...
    ## Get attribute (for now vector of ones since single phase, later play with region)
    ...
    np.savez_compressed('testmesh', nc=nc, order=order, nodes=nodes, elems=elems, faces=faces, marks=marks, att=att)
