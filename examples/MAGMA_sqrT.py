...
def main():
    ...
    def needs_refinement(vertices, area):
        ...
        max_area = 5e-6# + (la.norm(bary, np.inf) - 1) * 0.01
    ...
    np.savez_compressed('BMT_mesh', nc=nc, order=order, nodes=nodes, elems=elems, faces=faces, marks=marks, att=att)
